...
class Game():
    ...
    def getInitBoard(self):
        ...
        metadata = torch.tensor([12,0,-1,12,12,0,-1,12,0])
    ...
    def getActionSize(self):
        ...
        """
        return torch.prod(torch.tensor(self.getInitBoard()[0].size())) + 1
    ...
    def getCanonicalForm(self, board, player):
        ...
        if player == 1:
            ...
            board[0] = board[0] * -1
            data = board[1]
            board[1] = torch.tensor([data[4],data[5],data[6],data[7],data[0],data[1],data[2],data[3],data[-1]])
            return board
